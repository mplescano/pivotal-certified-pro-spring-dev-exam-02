...
@ContextConfiguration(classes = {SpringUnitTest2.MockCtxConfig2.class})
public class SpringUnitTest2 {

    public static final Long PERSON_ID = 1L;

    @Autowired
    @Qualifier("jdbcPersonRepo2")
    ...
    static class MockCtxConfig2 {
        ...
        @Bean
        PersonRepo jdbcPersonRepo2() {
            return new JdbcPersonRepo(jdbcTemplate2());
        }
